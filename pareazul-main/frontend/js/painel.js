...
function atualizaDadosPerfil() {
  ...
  if (parseInt(usuario_logado) > 0) {
    ...
    callApi(method, rota, function (data) {
      ...
      document.querySelector("#nome-usuario-logado").innerHTML =
        nome_usuario_logado;
...
function loadDadosEstacionamentoAtual(data, placa) {
  ...
  const cardEstacionamento =
    ...
    `</h3>
                                                    ...
                                                    <h4 class="painel-texto-simples">R$ ` +
    valorEstacionamento +
    `</h4>
                                                </div>
                                            </div>
    ...
    const cardCartaoAtual =
      ...
      `</h3>
            ...
            <div class="ant-col-4">
                <div class="">
                    <button type="button"
                    class="btn btn-danger" onclick="excluirCartao('` +
      cartao_id +
      `')">Excluir</button>
                </div>                                                
            </div>
...
function loadDadosVeiculo(aListaVeiculos) {
  ...
  aListaVeiculos.forEach(function (data, key) {
    ...
    const cardVeiculoAtual =
      ` <div class="ant-row-flex ant-row-flex-space-between card-apresentacao">
                    <div class="ant-col-14">
                        <div class="ant-row">
                            <div class="">
                                <h1 class="card-apresentacao-texto">` +
      placa +
      `</h1>
      ...
      `
                    <div class="ant-col-4">
                        <div class="">
                            <button type="button"
                            class="btn btn-danger" onclick="excluirVeiculo('` +
      veiculo_id +
      `')">Excluir</button>
                        </div>                                                
                    </div>
...
function getEstacionamento(dadosEstacionamento, veiculo_id) {
  return (
    ...
    `">
        ...
        <!-- Modal -->
        <div class="modal fade" id="novo-estacionamento-` +
    veiculo_id +
    `" tabindex="-1"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="veiculo_id-` +
    veiculo_id +
    `" disabled value="` +
    veiculo_id +
    `">
    ...
    dadosEstacionamento.placa +
    ` - ` +
    dadosEstacionamento.modelo +
    `
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control"
                                    ...
                                    placeholder="PLACA" disabled value="` +
    dadosEstacionamento.placa +
    `">
                            </div>
    ...
    `"
                        ...
                        <button type="button"
                            class="btn btn-primary" onclick="confirmarEstacionamento(` +
    veiculo_id +
    `)">Confirmar</button>
                    </div>
                </div>
...
function excluirVeiculo(codigo) {
  ...
  callApi(method, rota, function (data) {
    ...
    if (data.length > 0) {
      alert(
        "Este veiculo tem vinculo de estacionamento e nao pode ser excluido!"
      );
    } else {
      const method = "DELETE";
